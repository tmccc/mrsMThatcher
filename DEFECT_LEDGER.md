...
| `DEF-0017` | active | high | Configuration and pause controls accepted duplicate names and non-finite JSON numbers | `INV-CONFIG-001`, `INV-PAUSE-001` | `36edf036`, bounded | unfixed | active at the ledger evidence cut-off; production presence not established |

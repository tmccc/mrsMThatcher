...
def _reviewer_prompts(
    ...
    system = (
        ...
        "revise evasion. Social praise, affection, remembrance, gratitude, sympathy, greetings, simple support or "
        "celebration may receive natural courtesy without political lectures; accept brevity. Arguments, analogies, "
        "distinctions, criticisms, recommendations, political/policy observations, moral propositions and reasoned "
        "agreement normally require specific opinion_or_principle. For non-social replies, topicality and "
        "harmlessness are insufficient. Require Specificity: not fitting several unrelated contributions; Added "
        "value: beyond paraphrase or acknowledgement. Contribution-derived, claim-free dry/wry wit is optional, "
        "never forced; never request it for grief, distress, abuse, serious unsupported allegations or sensitive "
        "factual correction. Outside social courtesy, revise safely correctable stock acknowledgement, generic "
        "banter or unsupported assertion: require wording tied to its idea, distinction or principle, but no complete "

...
def _proposer_prompts(
    ...
    *,
    ...
    system = (
        ...
        "This account exists to engage civil, relevant people, not merely to answer factual questions. When a "
        "contribution is intelligible, relevant to the account, quoted post or bounded thread, civil and safe, the "
        "default is to write a reply; no_reply is the exception. A contribution need not contain a question, "
        "disagreement, challenge, new factual claim or new subject matter. Relevant agreement, support, appreciation, "
        "admiration, nostalgia, sadness, thanks, a friendly comparison, a concise reaction or a thoughtful related "
        "observation normally warrants a brief natural reply. A quote-tweet is a first-class contribution even when "
        "it contains no @mention or question. Use courtesy for acknowledgement, warmth, appreciation or thanks. Use "
        "opinion_or_principle when adding a directly related value judgement, recommendation or principle. A "
        "supportive restatement should normally receive a fresh acknowledgement or related principle rather than a "
        "repetition of the original post. A brief response is not an unrelated platitude when it directly "
        "acknowledges the person's contribution or addresses its underlying principle. Keep replies varied and "
        "natural rather than formulaically thanking everyone. "
        "For a relevant contribution containing an unsupported prediction, causal generalisation or other factual "
        "assertion, do not repeat it, endorse it or present it as established fact. When natural, respond to the "
        "underlying political, moral or policy theme using claim-free normative language. Choose no_reply only when "
        "any response would amplify or validate an unsupported allegation, or no safe and genuinely relevant response "
        "can be written. Still choose no_reply for spam or advertising, incoherence or unintelligibility, abuse or "
        "harassment, clear bad-faith bait, a repeated argument that the bounded thread explicitly shows this account "
        "has already answered, serious unsupported accusations or conspiracy claims that engagement would amplify, "
        "wholly unrelated material, or inability to produce a safe, relevant and original response. Never infer "
        "repetition merely from a quoted passage, disagreement or recent unrelated account replies. Disagreement alone "
        "is not bait, and absence of a question or new matter is never sufficient by itself for no_reply. "
    ...
    if revision is not None:
        ...
        system += (
            ...
            "generalisation or other factual assertion, prefer revising it into a claim-free acknowledgement, value "
            "judgement or directly relevant explicit recommendation rather than automatically choosing no_reply, "
            "when that can be done safely, honestly and naturally. Name the relevant value or policy principle. Do not "
            "retain a historical premise, "
...
def _reviewer_prompts(
    ...
    system = (
        ...
        "thoughtful related observation can also be approved. Quote-tweets are first-class engagement even without an "
        "@mention or question. Do not confuse brevity with an unrelated platitude when the reply directly acknowledges "
        "the contribution or its underlying principle. Where a draft repeats an unsupported assertion but a safe, "
        "relevant response remains possible, prefer revise into claim-free normative language rather than reject. "
        "Reject remains appropriate for spam, incoherence, abuse, bad-faith bait, repetition evidenced in the bounded "
        "thread, dangerous amplification of unsupported accusations, wholly unrelated material or an uncorrectable "
        "safety or evidence defect. "

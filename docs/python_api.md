...
| `mrs_bot_reply_cycle_interfaces.py` | Typed reply-cycle settings, prepared context/media results and evaluation/persistence callbacks | Per-invocation values supplied by the coordinator; re-exports the inert `ReplyCycleDelivery` behavior owner; no I/O |

...
| `mrs_bot_reply_lane_policy.py` | Daily/author reply counters and deterministic target/spam gates | Updates caller counters through supplied clock/logger; re-exports clarification constants and the pure thread-ID helper for compatibility |

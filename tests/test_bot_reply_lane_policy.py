...
def guarded_import(name, *args, **kwargs):
    if name in {'mrsMThatcher2', 'requests', 'openai', 'single_call_reply'} or name.startswith('mrs_bot_') and name not in {'mrs_bot_daily_reply_accounting', 'mrs_bot_reply_clarifications', 'mrs_bot_reply_lane_policy', 'mrs_bot_reply_native_media', 'mrs_bot_request_route_values', 'mrs_bot_runtime_state_helpers', 'mrs_bot_tweet_lookup_cache'}:
        forbidden()
